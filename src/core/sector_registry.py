...
_PROFILE_SPECS: list[tuple] = [
    ...
    (
        ...
        ["react", "vue", "node.js", "typescript", "api rest", "déploiement web",
         "frontend", "backend", "full stack", "rest api", "web development",
    ...
    (
        ...
        ["swift", "kotlin", "react native", "flutter", "app store", "sdk mobile",
         "mobile app", "ios development", "android development", "cross-platform"],
    ),
    (
        ...
        ["kubernetes", "terraform", "helm", "pipeline ci/cd", "infrastructure as code",
         "déploiement continu",
         "continuous deployment", "cicd", "ci/cd", "ansible", "docker",
         "containerization", "orchestration", "pipeline", "jenkins", "gitlab ci",
         "k8s", "aws", "deployment", "container", "monitoring", "infrastructure",
         "cloud computing", "version control", "cloud"],
    ),
    (
        ...
        ["selenium", "pytest", "plan de test", "regression testing", "bdd", "cypress",
         "test automation", "unit testing", "integration testing", "test cases",
    ...
    (
        ...
        ["roadmap produit", "backlog", "user stories", "okr", "wireframes", "sprint",
         "product roadmap", "stakeholder", "agile", "product backlog", "go to market",
         "go-to-market", "kpi"],
    ),
    (
        ...
        ["figma", "wireframes", "tests utilisateurs", "parcours utilisateur",
         ...
         "user research", "usability testing", "prototyping", "user journey",
    ...
    (
        ...
        ["power bi", "tableau", "sql", "reporting data", "dashboard décisionnel",
         "excel avancé",
         "data analysis", "business intelligence", "dashboard", "reporting", "sql queries",
    ...
    (
        ...
        ["scikit-learn", "feature engineering", "validation croisée",
         ...
         "predictive modeling", "statistical analysis", "hypothesis testing",
         "data mining", "regression", "classification", "machine learning",
    ...
    (
        ...
        ["mlflow", "kubeflow", "pipeline mlops", "déploiement modèle",
         ...
         "feature engineering", "gradient boosting", "model deployment", "inference"],
    ),
    (
        ...
        ["microservices", "design patterns", "scalabilité", "api gateway",
         ...
         "software architecture", "system design", "scalability", "distributed systems",
         "event driven", "domain driven", "clean architecture"],
    ),
    (
        ...
        ["siem", "pentest", "iso 27001", "cve vulnérabilité", "soc analyste",
         "réponse incident",
         "penetration testing", "vulnerability", "threat detection", "security audit",
         "firewall", "encryption", "incident response", "cybersecurity"],
    ),
