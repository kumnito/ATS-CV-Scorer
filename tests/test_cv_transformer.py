...
Two-column tests run against committed synthetic PDFs generated by
tests/fixtures/generate_two_column_fixtures.py (reportlab, native text).
"""
...
TWO_COLUMNS_PDF = FIXTURES / "synth_two_columns_simple.pdf"
...
# ---------------------------------------------------------------------------
# synth_two_columns_sidebar.pdf — regression tests (cross-column name + PASSIONS)
# ---------------------------------------------------------------------------

KEO_PEN_PDF = FIXTURES / "synth_two_columns_sidebar.pdf"
...
def test_keo_pen_name_includes_pen(keo_pen_cv):
    # Bug 3 : nom fragmenté "Keo" (col. gauche) + "PEN" (col. droite) → doit être fusionné.
